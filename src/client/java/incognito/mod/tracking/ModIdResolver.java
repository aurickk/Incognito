...
public class ModIdResolver {
    ...
    public static String getModIdFromPath(Path path) {
        ...
        try {
            ...
            Incognito.LOGGER.debug("[ModIdResolver] Failed to read mod ID from path {}: {}", path, e.getMessage());
        }
    ...
    public static String getModIdFromClass(Class<?> clazz) {
        ...
        try {
            ...
            Incognito.LOGGER.debug("[ModIdResolver] Failed to get mod ID from class {}: {}", 
